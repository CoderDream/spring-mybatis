...
$(function (){
	$('#tab2').datagrid({
		url:"<%=basePath %>student.do?method=getStudentScoreInfo",
		fitColumns:true,
		singleSelect:true,
		pagination:true,
		pageSize:10,
		...
		columns:[[
		          ...
		          {field:'totalScore',title:'得分',halign:'center',align:'center',width:20},
...
<body class="abody">
	<div class="easyui-panel" title="已完成试卷信息"  data-options="headerCls:'panel_title_1',collapsible:false">
