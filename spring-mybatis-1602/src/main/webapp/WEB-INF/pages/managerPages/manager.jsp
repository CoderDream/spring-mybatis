		...
		$('#tt').tree({
			...
			data: [{
				...
				children: [{
					"iconCls":"icon-edit",    
					text: '题库管理',
					url:'<%=basePath%>/manager.do?method=enterTikuPage'
				},{
					"iconCls":"icon-edit",    
					text: '试卷管理',
					url:'<%=basePath%>/manager.do?method=enterPaperPage'
				}
				
				<%-- ,{
					"iconCls":"icon-edit",    
					text: '成绩统计',
					url:'<%=basePath%>/manager.do?method=enterStudentScorePage'
				} --%>
				...
				children: [{
					"iconCls":"icon-edit",    
					text: '账号维护',
					url:'<%=basePath%>/manager.do?method=enterAccountMaintainPage'
				},{
					"iconCls":"icon-edit",    
					text: '退出系统',
				}]
