 ...
 */
(function(host) {
	var window = host || window, doc = document, selectedCity = "", popUpCityFrame = null, selectEventProxy = null, hotEventProxy = null, scrollEventProxy = null, toString = Object.prototype.toString, city = {
		A : [ {
			name : "阿坝",
			spell : "aba"
		}, {
		...
		name : "齐齐哈尔",
		spell : "qiqihar"
	} ], KEY = [ "A", "B", "C", "D", "E", "F", "G", "H", "", "J", "K", "L",
			"M", "N", "", "P", "Q", "R", "S", "T", "", "", "W", "X", "Y", "Z" ], ID = {
	...
	function createCityTopHtml() {
		var fragment = doc.createDocumentFragment(), strong = doc
				.createElement("strong"), txt1 = doc.createTextNode("城市索引："), txt2 = doc
				.createTextNode("全部"), p = doc.createElement("p"), a = doc
				.createElement("a");
	...
	function createHotCityHtml() {
		var fragment = doc.createDocumentFragment(), strong = doc
				.createElement("strong"), txt = doc.createTextNode("热门城市："), currentCity = null, cityText = "", link = null;
	...
	function createCityTRHtml() {
		...
		for ( var miao in city) {
			if (city.hasOwnProperty(miao)) {
				var tr = doc.createElement("tr"), th = doc.createElement("th"), td = doc
						.createElement("td"), span = doc.createElement("span"), text = doc
						.createTextNode(miao), miaoArray = city[miao], currentMiao = null, a = null;
	...
	function createCityContentHtml() {
		var fragment = doc.createDocumentFragment(), h4 = doc
				.createElement("h4"), table = doc.createElement("table"), colgroup = doc
				.createElement("colgroup"), tbody = doc.createElement("tbody"), col1 = doc
				.createElement("col"), col2 = doc.createElement("col"), h4Text = doc
				.createTextNode("全部城市："), trHtml = createCityTRHtml();
	...
	function cityScroll(m) {
		if (m && typeof m === "string") {
			m = m.toUpperCase();
			if (doc.all) {
				var cityListDiv = doc.getElementById(ID.cityList), tr = doc
						.getElementById("miao_" + m);
				if (tr !== null) {
	...
	function addSelectEvent(proxyTag, type, callback) {
		proxyTag["on" + type] = function(e) {
			var event = e || window.event, target = event.srcElement
					|| event.target;
	...
	function createFrame() {
		var cityFrame = doc.createElement("div"), cityTop = doc
				.createElement("div"), cityHot = doc.createElement("p"), cityList = doc
				.createElement("div"), cityCont = doc.createElement("div"), hotCityHtml = createHotCityHtml(), cityContentHtml = createCityContentHtml(), cityTopHtml = createCityTopHtml();
	...
	var citypicker = {
		...
		show : function() {
			var lenght = arguments.length, options, point = citypicker.point, callback = citypicker.callback;
			if (lenght == 2) {
				point = arguments[0];
		...
		fix : function(point) {
			if (point && typeof point === "object") {
				var left = parseInt(point.left, 10) || 0, top = parseInt(
						point.top, 10) || 0;
				citypicker.point = {
					left : left,
					top : top
