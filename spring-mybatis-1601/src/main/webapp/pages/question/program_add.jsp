...
<div class="button_bar">
	<button class="button_b_b button_bar_btnText" onclick="location.href='pages/question/program_list.jsp'">查询选题</button> 
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</div>

<form id="shortAnwserForm" action="fsp/insertFsp2.do" method="post">
	<!-- 隐藏字段 -->
	<input type="hidden" name="questionType" value="6"/>
      ...
      <table cellpadding="0" cellspacing="0" border="0px">
	   	<tr>
	   		<th align="left"><font color="red"><b>*&nbsp;</b></font>编程题题干</th>
	   	</tr>
	   	<tr>
	   		<td><textarea name="question" cols="80" rows="3">${fsp.question }</textarea></td>
	   	</tr>
	   	<tr>
	   		<th align="left"><br/><font color="red"><b>*&nbsp;</b></font>标准答案</th>
	   	</tr>
	   	<tr>
	   		<td><textarea name="stdAnswer" cols="80" rows="20">${fsp.stdAnswer }</textarea></td>
	   	</tr>
	   	<tr>
